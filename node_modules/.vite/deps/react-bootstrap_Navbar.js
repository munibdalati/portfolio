...
import {
  ...
  usePrevious,
  useUncontrolled
} from "./chunk-DYXIGUNN.js";
import {
  divWithClassName_default
} from "./chunk-5HYMXFKJ.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-JT4Z2NGX.js";
import {
  u
} from "./chunk-5VHUXVSJ.js";
import {
  A,
  F as F2,
  N,
...
var Collapse = wn.forwardRef(({
  ...
  const handleEnter = F2(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = "0";
  }, onEnter), [computedDimension, onEnter]);
  const handleEntering = F2(() => createChainedFunction_default((elem) => {
    const scroll = `scroll${computedDimension[0].toUpperCase()}${computedDimension.slice(1)}`;
    elem.style[computedDimension] = `${elem[scroll]}px`;
  }, onEntering), [computedDimension, onEntering]);
  const handleEntered = F2(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  }, onEntered), [computedDimension, onEntered]);
  const handleExit = F2(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = `${getDimensionValue(computedDimension, elem)}px`;
    triggerBrowserReflow(elem);
  }, onExit), [onExit, getDimensionValue, computedDimension]);
  const handleExiting = F2(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  }, onExiting), [computedDimension, onExiting]);
  return u(TransitionWrapper_default, {
    ref,
...
var NavbarCollapse = N(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context = q(NavbarContext_default);
  return u(Collapse_default, {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = F2(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Context = F(canUseDOM_default ? window : void 0);
...
function renderTransition(Component, runTransition, props) {
  if (Component) {
    return u(Component, Object.assign({}, props));
  }
  if (runTransition) {
    return u(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return u(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = N((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => u("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : u("div", Object.assign({}, dialogProps, {
...
var AbstractModalHeader = N(({
  ...
  const context = q(ModalContext_default);
  ...
  return u("div", {
    ref,
    ...props,
    children: [children, closeButton && u(CloseButton_default, {
...
var OffcanvasHeader = N(({
  ...
  return u(AbstractModalHeader_default, {
    ref,
    ...props,
...
function DialogTransition(props) {
  return u(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return u(Fade_default, {
    ...props
  });
}
var Offcanvas = N(({
  ...
  return u(g, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), u(ModalContext_default.Provider, {
      value: modalContext,
      children: u(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = N((props, ref) => {
  const context = q(NavbarContext_default);
  return u(Offcanvas_default, {
    ref,
...
var Navbar = N((props, ref) => {
  ...
  const navbarContext = F2(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return u(NavbarContext_default.Provider, {
    value: navbarContext,
    children: u(SelectableContext_default.Provider, {
