import {
  ...
  q,
  y as y2
} from "./chunk-Y4TTS6SX.js";
import {
  F,
  b,
  g,
  y
} from "./chunk-WQN5GMGS.js";
...
function createRouter(init) {
  ...
  function enableScrollRestoration(positions, getPosition, getKey) {
    ...
    if (!initialScrollRestored && state.navigation === IDLE_NAVIGATION) {
      ...
      let y3 = getSavedScrollPosition(state.location, state.matches);
      if (y3 != null) {
        updateState({
          restoreScrollPosition: y3
        });
      }
    }
    return () => {
  ...
  function getSavedScrollPosition(location, matches) {
    if (savedScrollPositions2) {
      let key = getScrollKey(location, matches);
      let y3 = savedScrollPositions2[key];
      if (typeof y3 === "number") {
        return y3;
      }
    }
...
var DataRouterContext = F(null);
if (true) {
  DataRouterContext.displayName = "DataRouter";
}
var DataRouterStateContext = F(null);
if (true) {
  DataRouterStateContext.displayName = "DataRouterState";
}
var AwaitContext = F(null);
if (true) {
  AwaitContext.displayName = "Await";
}
var NavigationContext = F(null);
if (true) {
  NavigationContext.displayName = "Navigation";
}
var LocationContext = F(null);
if (true) {
...
function useLocation() {
  ...
  return q(LocationContext).location;
}
function useNavigationType() {
  return q(LocationContext).navigationType;
}
function useMatch(pattern) {
  ...
  return F2(() => matchPath(pattern, pathname), [pathname, pattern]);
}
var navigateEffectWarning = "You should call navigate() in a React.useEffect(), not when your component is first rendered.";
function useIsomorphicLayoutEffect(cb) {
  let isStatic = q(NavigationContext).static;
  if (!isStatic) {
    y2(cb);
  }
}
...
function useNavigateUnstable() {
  ...
  let dataRouterContext = q(DataRouterContext);
  let {
    basename,
    future,
    navigator
...
var OutletContext = F(null);
function useOutletContext() {
  return q(OutletContext);
}
function useOutlet(context) {
  let outlet = q(RouteContext).outlet;
  if (outlet) {
    return y(OutletContext.Provider, {
      value: context
    }, outlet);
  }
  return outlet;
...
function useResolvedPath(to, _temp2) {
  ...
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches, future.v7_relativeSplatPath));
  return F2(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to, routePathnamesJson, locationPathname, relative]);
}
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg && renderedMatches) {
    return y(LocationContext.Provider, {
      value: {
        location: _extends2({
          pathname: "/",
          search: "",
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = y(g, null, y("p", null, "💿 Hey developer 👋"), y("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", y("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", y("code", {
      style: codeStyles
    }, "errorElement"), " prop on your route."));
  }
  return y(g, null, y("h2", null, "Unexpected Application Error!"), y("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? y("pre", {
...
var defaultErrorElement = y(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends b {
  ...
  render() {
    return this.state.error !== void 0 ? y(RouteContext.Provider, {
      value: this.props.routeContext
    }, y(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  return y(RouteContext.Provider, {
    value: routeContext
  }, children);
}
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => {
      ...
      if (error) {
        ...
        children = y(match.route.Component, null);
      } else if (match.route.element) {
        children = match.route.element;
      } else {
        children = outlet;
      }
      return y(RenderedRoute, {
        match,
        routeContext: {
          outlet,
          matches: matches2,
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? y(RenderErrorBoundary, {
...
function useDataRouterContext(hookName) {
  let ctx = q(DataRouterContext);
  !ctx ? true ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return ctx;
}
function useDataRouterState(hookName) {
  let state = q(DataRouterStateContext);
  !state ? true ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = q(RouteContext);
...
function useMatches() {
  ...
  return F2(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
...
function MemoryRouter(_ref3) {
  ...
  let setState = T((newState) => {
    v7_startTransition && startTransitionImpl ? startTransitionImpl(() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl, v7_startTransition]);
  y2(() => history.listen(setState), [history, setState]);
  return y(Router, {
    basename,
    children,
    location: state.location,
...
function Navigate(_ref4) {
  ...
  p(() => navigate(JSON.parse(jsonPath), {
    replace,
    state,
    relative
...
function Router(_ref5) {
  ...
  return y(NavigationContext.Provider, {
    value: navigationContext
  }, y(LocationContext.Provider, {
    children,
...
function Await(_ref7) {
  ...
  return y(AwaitErrorBoundary, {
    resolve,
    errorElement
  }, y(ResolveAwait, null, children));
}
...
var AwaitErrorBoundary = class extends b {
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error) {
      return y(AwaitContext.Provider, {
        value: promise,
        children: errorElement
      });
    }
...
function createRoutesFromChildren(children, parentPath) {
  ...
  let routes = [];
  A.forEach(children, (element, index) => {
    if (!fn(element)) {
      return;
    }
    let treePath = [...parentPath, index];
...
function mapRouteProperties(route) {
  ...
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: y(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: y(route.ErrorBoundary),
...
var ViewTransitionContext = F({
  isTransitioning: false
});
if (true) {
  ViewTransitionContext.displayName = "ViewTransition";
}
var FetchersContext = F(/* @__PURE__ */ new Map());
if (true) {
...
function RouterProvider(_ref) {
  ...
  let fetcherData = _(/* @__PURE__ */ new Map());
  let {
    v7_startTransition
  } = future || {};
  let optInStartTransition = T((cb) => {
  ...
  y2(() => router.subscribe(setState), [router, setState]);
  p(() => {
  ...
  let dataRouterContext = F2(() => ({
    router,
    navigator,
    static: false,
    basename
  }), [router, navigator, basename]);
  return y(g, null, y(DataRouterContext.Provider, {
    value: dataRouterContext
  }, y(DataRouterStateContext.Provider, {
    value: state
  }, y(FetchersContext.Provider, {
    value: fetcherData.current
  }, y(ViewTransitionContext.Provider, {
    value: vtContext
  }, y(Router, {
    basename,
    location: state.location,
  ...
  }, state.initialized || router.future.v7_partialHydration ? y(DataRoutes, {
...
var Link = N(function LinkWithRef(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = N(function NavLinkWithRef(_ref8, ref) {
  let {
  ...
  let routerState = q(DataRouterStateContext);
  let {
    navigator,
    basename
  } = q(NavigationContext);
...
function useSearchParams(defaultInit) {
  ...
  let defaultSearchParamsRef = _(createSearchParams(defaultInit));
  let hasSetSearchParamsRef = _(false);
  let location = useLocation();
  let searchParams = F2(() => (
  ...
  let navigate = useNavigate();
  let setSearchParams = T((nextInit, navigateOptions) => {
...
function useSubmit() {
  ...
  return T(function(target, options) {
    if (options === void 0) {
      options = {};
    }
...
function useFormAction(action, _temp2) {
  ...
  let routeContext = q(RouteContext);
...
function useFetcher(_temp3) {
  ...
  let fetcherData = q(FetchersContext);
  let route = q(RouteContext);
  ...
  let FetcherForm = F2(() => {
    let FetcherForm2 = N((props, ref) => {
      return y(Form, _extends3({}, props, {
        navigate: false,
        fetcherKey,
        ref
      }));
  ...
  let fetcherWithComponents = F2(() => _extends3({
    Form: FetcherForm,
    submit,
    load
  }, fetcher, {
...
function useViewTransitionState(to, opts) {
  ...
  let vtContext = q(ViewTransitionContext);
